...
func generateConstructor(wr io.Writer, ts *types.TypeName, registry *format.TypeFormatterRegistry, fields []fieldProjection, formatter format.StructFormatter) {
	fmt.Fprintf(wr, "const %s(", formatter.Name(ts, false))
